...
void I2C1_Clear_Busy_Flag(void) {
  ...
  // 2. Configure SCL (PA15) and SDA (PB9) as Output Open-Drain
...
// 1. micro-ROS requires usleep for internal delays.
...
// 2. Memory barrier for micro-ROS timers
void __sync_synchronize(void) {
    __asm__ volatile ("dmb" ::: "memory"); // Native Cortex-M4 Data Memory Barrier
}
